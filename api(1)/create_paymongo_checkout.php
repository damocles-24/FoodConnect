...
try {
    ...
    payment_json(["success" => false, "message" => $e->getMessage()], 500);
}
...
$isHttps = $forwardedProto === "https" || (!empty($_SERVER["HTTPS"]) && strtolower((string)$_SERVER["HTTPS"]) !== "off");
$scheme = $isHttps ? "https" : "http";
$host = trim((string)($_SERVER["HTTP_HOST"] ?? "localhost"));
if ($host === "") {
    $host = "localhost";
}
$returnBase = $scheme . "://" . $host . "/FoodConnect/frontend/html/cart.html";
...
if ($responseBody === false) {
    payment_json([
        ...
        "details" => $curlError !== "" ? $curlError : null
    ], 502);
}
