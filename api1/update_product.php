...
if (
    ...
    respond_json([
        "success" => false,
        "message" =>
            "Price must be between PHP 0.01 and PHP 99,999,999.99."
    ], 422);
}
...
try {
    ...
    if ($oldDescription !== $newDescription) {
        if ($oldDescription === "" && $newDescription !== "") {
            $changes[] = "Product description added.";
        } elseif ($oldDescription !== "" && $newDescription === "") {
            $changes[] = "Product description removed.";
        } else {
            $changes[] = "Product description updated.";
        }
    }
